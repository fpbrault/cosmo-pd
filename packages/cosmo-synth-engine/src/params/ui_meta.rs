...
pub fn engine_param_default_v1(key: &str) -> Option<f32> {
    ...
    match key {
        ...
        "warpAAmount" => Some(line1.engine.pd().dcw_base),
        "warpBAmount" => Some(line2.engine.pd().dcw_base),
        "algoBlendA" => Some(line1.engine.pd().algo_blend),
        "algoBlendB" => Some(line2.engine.pd().algo_blend),
        "line1Level" => Some(line1.engine.pd().dca_base),
        "line2Level" => Some(line2.engine.pd().dca_base),
