...
fn build_algo_bench_params(algo: Algo) -> SynthParams {
    ...
    p.line1.engine.pd_mut().algo = algo;
    p.line1.engine.pd_mut().algo2 = None;
    p.line1.engine.pd_mut().algo_blend = 0.0;
    p.line1.engine.pd_mut().dcw_base = 0.85;
    p.line1.engine.pd_mut().dca_base = 0.85;
    p.line2.engine.pd_mut().algo = algo;
    p.line2.engine.pd_mut().algo2 = None;
    p.line2.engine.pd_mut().algo_blend = 0.0;
    p.line2.engine.pd_mut().dcw_base = 0.85;
    p.line2.engine.pd_mut().dca_base = 0.85;
    ...
    vec![
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line_select = LineSelect::L1PlusL2Prime;
                p.line1.engine.pd_mut().algo = Algo::Skew;
                p.line1.engine.pd_mut().algo2 = None;
                p.line1.engine.pd_mut().algo_blend = 0.0;
                p.line1.engine.pd_mut().dca_base = 0.85;
                p.line1.engine.pd_mut().dcw_base = 0.0;
                p.line2.engine.pd_mut().algo = Algo::Skew;
                p.line2.engine.pd_mut().algo2 = None;
                p.line2.engine.pd_mut().algo_blend = 0.0;
                p.line2.engine.pd_mut().dca_base = 0.85;
                p.line2.engine.pd_mut().dcw_base = 0.0;
                p.mod_matrix = ModMatrix::default();
                p.fx_slots = [
                    FxSlotConfig::Empty,
                    FxSlotConfig::Empty,
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line_select = LineSelect::L1PlusL2Prime;
                p.line1.engine.pd_mut().algo = Algo::Fof;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Cheby);
                p.line1.engine.pd_mut().algo_blend = 0.65;
                p.line1.engine.pd_mut().dcw_base = 0.95;
                p.line1.engine.pd_mut().dca_base = 0.85;
                p.line2.engine.pd_mut().algo = Algo::Cheby;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Ripple);
                p.line2.engine.pd_mut().algo_blend = 0.65;
                p.line2.engine.pd_mut().dcw_base = 0.95;
                p.line2.engine.pd_mut().dca_base = 0.85;
                p.mod_matrix = ModMatrix::default();
                p.fx_slots = [
                    FxSlotConfig::Empty,
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.line_select = LineSelect::L1PlusL2Prime;
                p.line1.engine.pd_mut().algo = Algo::Saw;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Skew);
                p.line1.engine.pd_mut().algo_blend = 0.15;
                p.line1.engine.pd_mut().dca_base = 0.85;
                p.line2.engine.pd_mut().algo = Algo::Pulse;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Square);
                p.line2.engine.pd_mut().algo_blend = 0.2;
                p.line2.engine.pd_mut().dca_base = 0.65;
                p.fx_slots = [
                    FxSlotConfig::default_for_type(FxSlotType::Compressor),
                    FxSlotConfig::Empty,
                    FxSlotConfig::Empty,
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line1.engine.pd_mut().algo = Algo::Fof;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Ripple);
                p.line1.engine.pd_mut().algo_blend = 0.55;
                p.line1.engine.pd_mut().dcw_base = 0.85;
                p.line1.engine.pd_mut().dca_base = 0.8;
                p.line2.engine.pd_mut().algo = Algo::MultiSine;
                p.line2.engine.pd_mut().algo2 = Some(Algo::SawPulse);
                p.line2.engine.pd_mut().algo_blend = 0.45;
                p.line2.engine.pd_mut().dcw_base = 0.9;
                p.line2.engine.pd_mut().dca_base = 0.72;
                p.lfo.rate = 4.2;
                p.lfo2.rate = 6.0;
                p.random.rate = 9.0;
                p.mod_matrix = heavy_mod_matrix();
        ...
        Scenario {
            ...
            build_params: || {
                let mut p = SynthParams::default();
                p.poly_mode = PolyMode::Poly8;
                p.line1.engine.pd_mut().algo = Algo::Cheby;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Fold);
                p.line1.engine.pd_mut().algo_blend = 0.6;
                p.line2.engine.pd_mut().algo = Algo::Twist;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Clip);
                p.line2.engine.pd_mut().algo_blend = 0.5;
                p.lfo.rate = 8.0;
                p.lfo2.rate = 12.0;
                p.random.rate = 16.0;
                p.mod_matrix = heavy_mod_matrix();
        ...
        Scenario {
            ...
            build_param_variants: Some(|| {
                ...
                a.line1.engine.pd_mut().algo = Algo::Skew;
                a.line1.engine.pd_mut().algo2 = None;
                a.line2.engine.pd_mut().algo = Algo::Skew;
                a.line2.engine.pd_mut().algo2 = None;
                a.volume = 0.35;
                a.lfo.rate = 2.0;
                ...
                b.lfo2.rate = 5.0;
                b.random.rate = 9.0;
                b.line1.engine.pd_mut().dcw_base = 0.6;
                b.line2.engine.pd_mut().dcw_base = 0.4;
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line_select = LineSelect::L1PlusL2Prime;
                p.line1.engine.pd_mut().algo = Algo::Cz101;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Sync);
                p.line1.engine.pd_mut().algo_blend = 0.55;
                p.line1.engine.pd_mut().algo_controls_a = algo_control_slots(&[
                    (AlgoControlId::Preset, 6.0),
                    (AlgoControlId::Waveform1, 5.0),
                    (AlgoControlId::Waveform2, 6.0),
                    (AlgoControlId::WindowFunction, 3.0),
                ]);
                p.line1.engine.pd_mut().algo_controls_b = algo_control_slots(&[
                ...
                p.line2.engine.pd_mut().algo = Algo::Skew;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Bend);
                p.line2.engine.pd_mut().algo_blend = 0.45;
                p.line2.engine.pd_mut().algo_controls_a = algo_control_slots(&[
                    (AlgoControlId::SkewBias, 0.55),
                    (AlgoControlId::SkewCurve, 0.72),
                    (AlgoControlId::SkewSpread, 0.48),
                    (AlgoControlId::SkewTilt, 0.38),
                ]);
                p.line2.engine.pd_mut().algo_controls_b = algo_control_slots(&[
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line1.engine.pd_mut().algo = Algo::Skew;
                p.line2.engine.pd_mut().algo = Algo::Saw;
                p.lfo.rate = 3.5;
                p.lfo2.rate = 2.75;
        ...
        Scenario {
            ...
            build_params: || {
                let mut p = SynthParams::default();
                p.poly_mode = PolyMode::Poly8;
                p.line1.engine.pd_mut().algo = Algo::MultiSine;
                p.line1.engine.pd_mut().algo2 = Some(Algo::Saw);
                p.line1.engine.pd_mut().algo_blend = 0.5;
                p.line2.engine.pd_mut().algo = Algo::Pulse;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Skew);
                p.line2.engine.pd_mut().algo_blend = 0.3;
                p.lfo.rate = 4.0;
                p.lfo2.rate = 3.25;
                p.mod_matrix = ModMatrix::default();
                p.fx_slots = [
        ...
        Scenario {
            ...
            build_params: || {
                ...
                p.poly_mode = PolyMode::Poly8;
                p.line1.engine.pd_mut().algo = Algo::Fof;
                p.line1.engine.pd_mut().algo2 = Some(Algo::MultiSine);
                p.line1.engine.pd_mut().algo_blend = 0.55;
                p.line2.engine.pd_mut().algo = Algo::Cheby;
                p.line2.engine.pd_mut().algo2 = Some(Algo::Saw);
                p.line2.engine.pd_mut().algo_blend = 0.45;
                p.lfo.rate = 7.5;
                p.lfo2.rate = 5.5;
                p.random.rate = 12.0;
