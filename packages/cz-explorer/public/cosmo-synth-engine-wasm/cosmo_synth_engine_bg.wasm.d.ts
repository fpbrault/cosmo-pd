...
export const czsynthprocessor_getMidiMappings: (a: number, b: number) => void;
...
export const czsynthprocessor_midiCc: (a: number, b: number, c: number, d: number) => void;
export const czsynthprocessor_new: (a: number) => number;
export const czsynthprocessor_noteOff: (a: number, b: number) => void;
export const czsynthprocessor_noteOn: (a: number, b: number, c: number) => void;
...
export const czsynthprocessor_setMidiLearnEnabled: (a: number, b: number) => void;
export const czsynthprocessor_setMidiLearnTarget: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
