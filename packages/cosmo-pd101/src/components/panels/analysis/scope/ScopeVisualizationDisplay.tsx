...
import { drawScopeBackdrop } from "./rendering/canvas";
import { isEditableKeyboardTarget } from "./rendering/keyboard";
import { getScopeThemePalette } from "./rendering/palette";
import { calculateFrameMean } from "./rendering/processing";
import {
	renderScopeVisualization,
	type ScopeVisualizationMode,
} from "./rendering/renderScopeVisualization";
import type { ScopeColorTheme, SpectrogramState } from "./rendering/types";
import { useWavetableWaterfallPreview } from "./waterfall/useWavetableWaterfallPreview";
