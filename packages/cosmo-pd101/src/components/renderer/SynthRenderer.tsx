...
import { PerformanceDiagnosticsProvider } from "@/components/performance/PerformanceDiagnosticsProvider";
...
const SynthRenderer = memo(function SynthRenderer({
	...
	const workspaceMode = useSynthUiStore((s) => s.workspaceMode);
	const setWorkspaceMode = useSynthUiStore((s) => s.setWorkspaceMode);
	...
	}, [keyboardVisible, keyboardPanelRef, setKeyboardVisible, workspaceMode]);
		...
		<HoverInfoProvider>
			<ModMatrixProvider modMatrix={modMatrix} setModMatrix={setModMatrix}>
				<SynthParamControllerProvider>
					...
					>
						<PerformanceDiagnosticsProvider runtime={runtime}>
							<div
								data-theme="cosmo"
