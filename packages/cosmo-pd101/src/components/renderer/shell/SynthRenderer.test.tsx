...
vi.mock("@/components/preset/navigation/SynthHeader", () => ({
	default: ({
		onStepPreset,
	}: {
...
vi.mock("@/components/layout/navigation/SynthSidebar", () => ({
	default: () => <div data-testid="synth-sidebar">sidebar</div>,
}));
vi.mock("@/components/preset/library/views/PresetLibrary", () => ({
	default: ({
		isOpen,
		onClose,
		allEntries,
...
vi.mock("../monitoring/useAudioLevelMonitor", () => ({
...
vi.mock("@/components/layout/keyboard/MiniKeyboardOverlay", () => ({
	default: () => <div data-testid="mini-keyboard-overlay" />,
}));
vi.mock("@/components/layout/shell/SynthInfoBar", () => ({
