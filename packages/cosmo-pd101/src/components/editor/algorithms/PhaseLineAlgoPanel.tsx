...
import { SynthSingleCycleDisplay } from "@/components/editor/waveforms/SingleCycleDisplay";
import Card from "@/components/primitives/containers/Card";
import PerLineParametersCard from "../phase-lines/PerLineParametersCard";
import { formatAlgoBlendReadout } from "../phase-lines/perLineWarpUtils";
import type {
	PhaseLineAlgoModel,
