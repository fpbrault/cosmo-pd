...
export type PluginIpcRequest = { method: "noteOn"; payload: {
	...
	index: number,
	value: number | null,
} } | { method: "panic" } | { method: "getParams" } | { method: "setParams"; payload: SynthParams } | { method: "getParamsVersion" } | { method: "getPendingParamChanges" } | { method: "getRuntimeModSources" } | { method: "getRuntimeVoiceStates" } | { method: "getRuntimeSequencerState" } | { method: "getTransportInfo" } | { method: "getScopeData" } | { method: "clientLog"; payload: {
	level: string,
	message: string,
