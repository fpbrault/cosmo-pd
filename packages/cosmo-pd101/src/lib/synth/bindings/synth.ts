...
export type EngineDefinitionV1 = {
	...
	envelopeTargets: [EnvelopeTargetDefinitionV1, EnvelopeTargetDefinitionV1, EnvelopeTargetDefinitionV1],
};
...
export type EnvelopeTargetDefinitionV1 = {
	slot: number,
	role: EnvelopeTargetRole,
};

export type EnvelopeTargetRole = "pitch" | "warp" | "tone" | "amplitude";
