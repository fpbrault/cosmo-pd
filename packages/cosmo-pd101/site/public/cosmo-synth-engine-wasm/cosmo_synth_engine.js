const wasm_bindgen = ((exports) => {
	...
	class CzSynthProcessor {
		...
		applyModulePreset(module, preset) {
			...
			const ret = wasm.czsynthprocessor_applyModulePreset(
				this.__wbg_ptr,
				ptr0,
				len0,
				ptr1,
		...
		setFxSlotType(slot, type_name) {
			...
			const len0 = WASM_VECTOR_LEN;
			const ret = wasm.czsynthprocessor_setFxSlotType(
				this.__wbg_ptr,
				slot,
				ptr0,
				len0,
	...
	function __wbg_get_imports() {
		const import0 = {
			__proto__: null,
			__wbg___wbindgen_copy_to_typed_array_4db0cbe2cc60dbee: (
				arg0,
				arg1,
				arg2,
			) => {
			...
			__wbg_error_744744ff0c9861e6: (arg0) => {
	...
	const CzSynthProcessorFinalization =
		typeof FinalizationRegistry === "undefined"
			...
			: new FinalizationRegistry((ptr) =>
					wasm.__wbg_czsynthprocessor_free(ptr, 1),
				);
