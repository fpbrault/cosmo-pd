...
let cosmoParameterSpecs: [CosmoParameterSpec] = [
    ...
    .init(id: 17, key: "lfoDepth", name: "LFO Depth", min: 0, max: 1, defaultValue: 0, unit: .generic, flags: [.flag_IsWritable, .flag_IsReadable, .flag_CanRamp]),
    ...
    .init(id: 20, key: "lfo2Depth", name: "LFO 2 Depth", min: 0, max: 1, defaultValue: 0, unit: .generic, flags: [.flag_IsWritable, .flag_IsReadable, .flag_CanRamp]),
