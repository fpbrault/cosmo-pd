//
//  CosmoPD101AUv3Ext_macOSExtensionAUProcessHelper.hpp
...
#include <vector>
#include "CosmoPD101AUv3Ext_macOSExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(CosmoPD101AUv3Ext_macOSExtensionDSPKernel& kernel)
    : mKernel{kernel}
    {
    }
...
private:
    CosmoPD101AUv3Ext_macOSExtensionDSPKernel& mKernel;
